...
this.spam = this.spam ? this.spam : {}
	...
	"displayName": "Pick Ford - Owner",
	"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:;Pick Ford - Owner;;;\nFN:Pick Ford - Owner\nitem1.TEL;waid=6283806211924:+62 838-0621-1924\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:Kamu melakukan spam hubungi owner untuk di unblock\nX-WA-BIZ-NAME:Pick Ford - Owner\nEND:VCARD",
	"contextInfo": {
		externalAdReply:{title: 'DITA - BOT', body: 'Follow My Facebook - Click photo',mediaUrl: 'https://www.facebook.com/profile.php?id=100077142458119', sourceUrl: 'https://www.facebook.com/profile.php?id=100077142458119', mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true,thumbnail: fs.readFileSync('./image/pick.png')}
	}
}]
}
})
...
conn.sendButGamc("6283806211924@s.whatsapp.net", [{ buttonId: `unblock23 ${quoted.sender.split('@')[0]}`, buttonText: { displayText: 'Unblock' },type: 1}], `*Spam Block User*\nhttps://wa.me/${quoted.sender.split("@")[0]}`, '•DITA BOT•\nCreated By PickFord', ppuser)
            }
...
conn.sendMessage(m.chat, {contacts: {displayName: '1',contacts:[{
	"displayName": "Pick Ford Ganteng ;-;",
	"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:;PickFord;;;\nFN:PickFord\nitem1.TEL;waid=6283806211924:+62 838-0621-1924\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:Pick Ford Owner Dita-Bot\nX-WA-BIZ-NAME:PickFord\nEND:VCARD",
	"contextInfo": {
		externalAdReply:{title: '*Sewa Bot*', body: 'Sewa bot join grup selama bot aktif\nCuman 5k pembayaran via Pulsa/Dana\nChat owner untuk melanjutkan',mediaUrl: 'https://wa.me/6283806211924', sourceUrl: 'https://wa.me/6283806211924', mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true,thumbnail: fs.readFileSync('./image/pem.jpg')}
	}
}]
}
})
...
case 'pubg':
if(arght.lenght<1) return reply('text nya mana su?')
text = body.slice(11)
p = await getBuffer(`https://api-alpis.herokuapp.com/api/photooxy/pubg?text=Pubg&text2=${text}`)
con.sendMassage(from, p, image, {quoted:mek, caption:'Done'})
...
case 'bug': {
if (!isCreator) return m.reply(mess.owner)
let ioi = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')
(async () => {
    ...
    conn.relayMessage(`${ioi}@s.whatsapp.net`, fur.message, {messageId: fur.key.id})
    }
)()
	}
	break
...
url: 'https://www.facebook.com/profile.php?id=100077142458119'
}
}, {
quickReplyButton: {
displayText: 'Owner',
...
id: 'menu'
  ...
  conn.sendButImg(i, txt, 'DITA-BOT\nCreated By PickFord', fs.readFileSync('./image/pem.jpg'), btn)
}
...
case 'trigger':{
    ...
    conn.sendImageAsSticker(m.chat, fs.readFileSync(`./trigger.jpg`), m, {packname: 'Sticker', author: 'DITA-BOT\nCreated By PickFord'})
}
create();
}
break
...
case 'dl': {
	...
	if(text.includes("youtu")) {
	    ...
	    conn.sendButtonText(m.chat, btnz, pesan, `DITA-BOT\nCreated By PickFord`, m)
...
return conn.sendMessage(m.chat, { document: {url: helo[0].url}, mimetype: 'image/jpeg', fileName: `${text}.jpg`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}}) /*conn.sendButDoc2(m.chat, "©Perwira Bot WhatsApp", '*Click Document untuk download*\n\n*Lokasi file*\nAndroid/media/com.whatsapp/WhatsApp/Media/WhatsApp Documents', `Instagram Download`, "©Perwira Bot WhatsApp", fs.readFileSync('./image/ig.jpeg'), text, 1, `${text}.jpg` , helo[0].url, 'image/jpeg', [{ buttonId: 'ok', buttonText: { displayText: 'Thanks' }, type: 1 }], m, true) */
} else if(mimeaxig.split("/")[0] === "video"){
return conn.sendMessage(m.chat, { document: {url: helo[0].url}, mimetype: 'video/mp4', fileName: `${text}.mp4`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}})
}
		} else {
...
/*sendButVid(m.chat, '*TikTok Downloader*', '©Perwira Bot WhatsApp', `${resion.medias.nowm.url}`, [{quickReplyButton: {displayText: 'Audio', id: `ttmp3 ${text}`}}])*/
	...
	if(text.includes('mediafire.com')) {
		...
		await mediafire(text).then(async datan => {
			if(datan[0].mime === 'zip') {
			conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'application/zip', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}}) 
			} else if(datan[0].mime === '9') {
					conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'application/vnd.android.package-archive', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}}) 
					} else if(datan[0].mime === '7z') {
					conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'application/7z', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}}) 
					} else if(datan[0].nama.endsWith('.mp4')) {
					conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'video/mp4', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}})
					} else if(datan[0].nama.endsWith('.pdf')) {
					conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'application/pdf', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}})
					} else {
					conn.sendMessage(m.chat, {document: {url: datan[0].link}, fileName: datan[0].nama, mimetype: 'application/octet-stream', contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `MediaFire Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/mfire.jpg')}}})
...
conn.sendMessage(m.chat, { document: { url: res.dl_link }, mimetype: 'audio/mpeg', fileName: `${res.title}.mp3`,contextInfo: {externalAdReply: {title: `${res.title}`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${search.videos[0].url}`, sourceUrl: `${search.videos[0].url}`, mediaType: 2, showAdAttribution: true, thumbnail: get_img}}}, {}).catch((e) => m.reply(String(e))).then(() => {
...
hydratedFooterText: "© DITA-BOT\nCreated By Pick Ford", hydratedButtons: templateButtones}}}}}
conn.relayMessage(m.chat, templateMessages, {})})();
} else {
await conn.sendMessage(m.chat, { document :{url: text.split("|")[1]}, mimetype: nap.headers['content-type'], fileName: `${text.split("|")[1].split("/")[5]}.apk`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Aplication Download`, body: "© DITA-BOT", mediaUrl: `${text.split("|")[1]}`, sourceUrl: `${text.split("|")[1]}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: await getBuffer(than.thumb)}}})
}
} else {
...
await conn.sendMessage(m.chat, { document: { url: res.dl_link }, mimetype: 'audio/mpeg', fileName: `${res.title}.mp3`,contextInfo: {externalAdReply: {title: `${res.title}`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: text, sourceUrl: text, mediaType: 2, showAdAttribution: true, thumbnail: ythumb}}}, {}).catch((e) => m.reply(String(e)))
...
conn.sendMessage(m.chat, { document: { url: res.dl_link }, mimetype: 'video/mp4', fileName: `${res.title}.mp4`,contextInfo: {externalAdReply: {title: `${res.title}`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: text, sourceUrl: text, mediaType: 2, showAdAttribution: true, thumbnail: ythum}}},{})
...
case 'github': {
	...
	try {
	conn.sendMessage(m.chat, {document: {url: text + "/archive/refs/heads/main.zip"}, mimetype: 'application/zip', fileName: `${text}.zip`, contextInfo: {externalAdReply: {title: "Github Download", body: "DITA-BOT\nCreated By PickFord", sourceUrl: text, mediaUrl: text, mediaType: 1, renderLargerThumbnail: true, thumbnail: fs.readFileSync(`./image/gh.png`)}}}, {quoted: m})
	} catch(e) {
		m.reply(String(e))
		}
	}
...
conn.sendMessage(m.chat, {document: {url: `${resioni.medias.audio.url}`}, ptt: false, mimetype: 'audio/mpeg', fileName: `${resioni.medias.audio.sound}.mp3`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Tiktok Downloader`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: text, sourceUrl: text, mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true, thumbnail: fs.readFileSync('./image/tiktok.jpeg')}}}) /*conn.sendButDoc2(m.chat, "©Perwira Bot WhatsApp", '*Click Document untuk download*\n\n*Lokasi file*\nAndroid/media/com.whatsapp/WhatsApp/Media/WhatsApp Documents', `TikTok Download`, "©Perwira Bot WhatsApp", fs.readFileSync('./image/tiktok.jpeg'), text, 1, `${resioni.medias.audio.sound}.mp3`, `${resioni.medias.audio.url}`, 'audio/mpeg', [{ buttonId: 'ok', buttonText: { displayText: 'Thanks' }, type: 1 }], m, true) */
} catch(e) {
...
conn.sendButVidc(m.chat, ddi, "*Tiktok Downloader*", '•DITA BOT•\nCreated By Pick Ford', `${resion.medias.nowm.url}`)
...
if(text.includes("tiktok.com")) {
	...
	conn.sendButVid(m.chat, '*TikTok Downloader*', 'DITA-BOT\nCreated By PickFord', `${res.result.nowatermark}`, [{quickReplyButton: {displayText: 'Audio', id: `ttmp3 ${text}`}}])
	} catch(e) {
	m.reply(String(e))
	}
...
conn.sendMessage(m.chat, {document: audii, ptt: false, mimetype: 'audio/mpeg', fileName: `${new Date()}.mp3`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Tiktok Downloader`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: text, sourceUrl: text, mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true, thumbnail: fs.readFileSync('./image/tiktok.jpeg')}}})
	} catch(e) {
	m.reply(String(e))
	}
	} else { m.reply(`Link yang anda masukkan tidak tepat!\nHarap masukkan link yang benar\n*Contoh :* ${prefix}ttdl2 https://vt.tiktok.com/ZSdeUA8T2/?k=1`) }
...
case 'wallpaper': {
	...
	if(swo.length === 0) return conn.sendButtonText(m.chat, [{buttonId: `i`, buttonText: {displayText: 'Oke'}, type:1}], `Sepertinya sudah sampai akhir`, `DITA-BOT\nCreated By PickFord`)
	lostii = []
	npi = 1
	for(let li of swo) {
		lostii.push({
...
conn.sendMessage(m.chat, listWall, {}).then(() => {
	...
	conn.sendButtonText(m.chat, btnzi, `List berikutnya`, `DITA-BOT\nCreated By PickFord`)
	})
} catch(err) {
	m.reply(String(err))
	}
	...
	if(sw.length === 0) return conn.sendButtonText(m.chat, [{buttonId: `i`, buttonText: {displayText: 'Oke'}, type:1}], `Wallpaper ${text} tidak tersedia`, `DITA-BOT\nCreated By PickFord`)
	losti = []
	np = 1
	for(let l of sw) {
		losti.push({
...
if(mimeaxig.split("/")[0] === "image"){
await conn.sendMessage(m.chat, { document: {url: resu.post1.url}, mimetype: 'image/jpeg', fileName: `${text}.jpg`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}}) /*conn.sendButDoc2(m.chat, "©Perwira Bot WhatsApp", '*Click Document untuk download*\n\n*Lokasi file*\nAndroid/media/com.whatsapp/WhatsApp/Media/WhatsApp Documents', `Instagram Download`, "©Perwira Bot WhatsApp", fs.readFileSync('./image/ig.jpeg'), text, 1, `${text}.jpg` , helo[0].url, 'image/jpeg', [{ buttonId: 'ok', buttonText: { displayText: 'Thanks' }, type: 1 }], m, true) */
} else if(mimeaxig.split("/")[0] === "video"){
await conn.sendMessage(m.chat, { document: {url: resu.post1.url}, mimetype: 'video/mp4', fileName: `${text}.mp4`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}})
}
})
		} else {
			m.reply(`Masukkan link!\n*Contoh :* ${prefix+command} https://www.instagram.com/p/CcejPskP8Ia/?igshid=YmMyMTA2M2Y=`)
...
await conn.sendMessage(m.chat, { document: {url: text}, mimetype: 'image/jpeg', fileName: `${text}.jpg`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}}) 
} else if(mimeax.split("/")[0] === "video"){
await conn.sendMessage(m.chat, { document: {url: text}, mimetype: 'video/mp4', fileName: `${text}.mp4`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}})
...
await conn.sendMessage(m.chat, { document: {url: ii.link}, mimetype: 'image/jpeg', fileName: `${text}.jpg`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Instagram Download`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: `${text}`, sourceUrl: `${text}`, renderLargerThumbnail: true, showAdAttribution: true, mediaType: 1, thumbnail: fs.readFileSync('./image/ig.jpeg')}}}) 
} else if(mimeax.split("/")[0] === "video"){
...
await conn.sendImageAsSticker(m.chat, `https://api.xteam.xyz/ttp?file&text=${encodeURI(text)}`, m, {packname: 'DITA-BOT\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n', author: 'PICK-FORD\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n'})
}
break
case 'attp':
{
...
@6283167714830 (Owner kedua)`
conn.sendMessage(m.chat, {contacts: {displayName: '1',contacts:[{
	"displayName": "Pick Ford",
	"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:;PickFord;;;\nFN:PickFord\nitem1.TEL;waid=6283806211924:+62 838-0621-1924\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:Owner DITA-BOT\nX-WA-BIZ-NAME:PickFord\nEND:VCARD",
	"contextInfo": {
		externalAdReply:{title: 'Owner', body: 'Follow My Acount - Click photo',mediaUrl: 'https://www.facebook.com/profile.php?id=100077142458119', sourceUrl: 'https://www.facebook.com/profile.php?id=100077142458119', mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true,thumbnail: fs.readFileSync('./image/pick.png')}
	}
}]
}
})
...
await conn.sendButLocc(m.chat, butts, butp, '•DITA BOT•\nCreated By Pick Ford', fs.readFileSync('./image/ppj.jpg'))
	} break
/*case 'info':{
	let btn = [{
callButton: {
...
await conn.sendButGif(m.chat, info, `DITA-BOT\nCreated By PickFord`, fs.readFileSync('./image/gify.mp4'), btn)
	}break*/
...
await conn.sendButGamc(m.chat, buttonis, annon, '•DITA BOT•\nCreated By PickFord', 'https://telegra.ph/file/e288599778146462da860.jpg')
...
await conn.sendButtonMenf(`${texot}@s.whatsapp.net`, quoted.sender, bunis, bi, '•DITA BOT•\nCreated By Pick Ford\n\nBalas pesan ini kepada pengirim dengan reply pesan dan command /balas isi pesan')
} catch(err) {
...
await conn.sendButLocc(m.chat, buttonis, annon, '•DITA BOT•\nCreated By PickFord', 'https://telegra.ph/file/e288599778146462da860.jpg')
	}
	break
...
conn.sendMessage(m.chat, {document: audiio, ptt: false, mimetype: 'audio/mpeg', fileName: `Facebook Audio ${new Date() * 1}.mp3`, contextInfo: {mentionedJid: [quoted.sender], externalAdReply: {title: `Facebook audio Converter`, body: "DITA-BOT\nCreated By PickFord", mediaUrl: text, sourceUrl: text, mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true, thumbnail: fs.readFileSync('./image/fb.png')}}}) 
...
conn.sendButVidc(m.chat, dodi, "*Facebook Downloader*", '•DITA BOT•\nCreated By Pick Ford', `${data.resource.hd ? data.resource.hd: data.resource.sd}`)
})
} else {
...
if(budy.includes("Assalamualaikum")) return m.reply("_Waalaikumussalam_")
/*
...
if (new Date() * 1 - insta.time > 3660000) {
	exec(`python ig.py viiannn_a`, (err, stdout) => {
	...
	if(stdout) return conn.sendMessage("120363021942310633@g.us", {text: stdout})
		...
		fs.writeFileSync('./database/insta.json', JSON.stringify(insta))
	}
